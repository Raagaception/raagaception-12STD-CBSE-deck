...
> Author's Note: This deck, despite being extensive and useful in it's own right, has syllabus gaps here and there, given that the CBSE/JEE/NEET syllabus is a massive ocean. There won't be any new further updates or additions to this project, since the we, the original authors of this repo don't have the time to maintain it or merge pull requests anymore. Volunteers to fork this project and continue the work independently are welcome. Decks and resources of a similar nature, unaffiliated with this project, may be used to fullfil the gaps in knowledge left by this deck. A few such supplementary decks are listed below:
